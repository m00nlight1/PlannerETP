...
import '../../feature/tasks/data/network_task_repository.dart' as _i10;
import '../../feature/tasks/domain/task_repository.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.TaskRepository>(
      () => _i10.NetworkTaskRepository(get<_i5.AppApi>()));
